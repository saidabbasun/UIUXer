...
import Img9 from '../../assets/images/IMAGE-10.png'
...
<Row>
   <Col>
   <Card img={Img10} title='Changelog'/>
   </Col>
   <Col>
   <Card img={Img9} title='Protected Page'/>
   </Col>
...
<Row>
   <Col>
   <Card img={Img12} title='CLicenses'/>
   </Col>
   <Col>
   <Card img={Img11} title='Style Guide'/>
   </Col>
...
<Row>
   <Col>
   <Card img={Img13} title='404 Error Page'/>
   </Col>
   <Col>
