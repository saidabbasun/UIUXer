...
<Row>
   <Col>
   <Card img={Img8} value='true' title='Changelog'/>
   </Col>
   <Col>
   <Card img={Img11} value='true' title='Protected Page'/>
   </Col>
...
<Row>
   <Col>
   <Card img={Img9} value='true' title='CLicenses'/>
   </Col>
   <Col>
   <Card img={Img12} value='true' title='Style Guide'/>
   </Col>
...
<Row>
   <Col>
   <Card img={Img10} value='true' title='404 Error Page'/>
   </Col>
   <Col>
