...
const Home = () => {
  return (
    <Card className="text-black homeCard text-end">
      <Card.Img src={bgHome} alt="Card image" />
      <Card.ImgOverlay className='cardImgOverlay' >
        <Card.Title className='title'>Tell your creativity to the  <divclassName='probell'></divclassName=> world with <span className='logoText'>UIUXer</span></Card.Title>
