...
const Home = () => {
  return (
    <Card className="text-black homeCard text-endr">
      <Card.Img src={bgHome} alt="Card image" />
      <Card.ImgOverlay className='cardImgOverlay' >
        <Card.Title className='title'>Tell your creativity to the  <span className='probel'> </span> world with <span className='logoText'>UIUXer</span></Card.Title>
